...
export function ChartPanel() {
  ...
  const src =
    `https://www.tradingview.com/widgetembed/?frameElementId=btc-orb-${tf}` +
    `&symbol=BITSTAMP%3ABTCUSD&interval=${tf}` +
  ...
  return (
    <div className="rounded-xl border border-border bg-panel overflow-hidden flex flex-col">
      <div className="flex items-center justify-between border-b border-border px-4 py-2.5">
        <span className="text-xs font-medium uppercase tracking-wide text-muted">BTCUSD — Grafico live</span>
