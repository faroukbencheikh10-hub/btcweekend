...
Copia di Soldi ORB portata su **BTCUSD**, pensata per girare nel weekend
...
e' la stessa qualunque sia il prezzo del bitcoin.

`SOLO_WEEKEND=true` limita l'analisi alla finestra venerdi 21:00 UTC -> domenica 22:00 UTC.

Il database usa le stesse tabelle di Soldi: la colonna `xauusd` contiene il prezzo BTCUSD.
